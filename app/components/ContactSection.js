 ...
 * formulario (nombre, email, mensaje) con animaciones de entrada vía
 * framer-motion (whileInView).
 *
 * OJO: el envío del formulario es SIMULADO. No envía nada a ningún lado;
 * solo muestra "Enviando..." y luego "¡Mensaje enviado!". Para producción
 * habría que conectarlo a una API (o EmailJS, Resend, etc.).
 */
'use client';
...
export default function ContactSection() {
  ...
  // Estado de envío: null | 'sending' | 'success'
  ...
  // Envío simulado: marca "sending", espera 1s y muestra éxito 3s.
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--bg-section-glass)]">
      <div className="max-w-6xl mx-auto">
        {/* Badge de sección con animación de entrada */}
        <motion.div
        ...
        <motion.h2
          ...
          className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mt-4 mb-4 text-[var(--ink-strong)]"
        >
          {t.contact.title}
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-[var(--ink-soft)] text-base sm:text-lg leading-relaxed max-w-[600px] mb-12"
        >
          ...
          >
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-accent-10 flex items-center justify-center text-[var(--accent)]">
                {/* Ícono de sobre (SVG inline, sin depender de lucide) */}
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm font-medium text-[var(--ink-strong)]">@lucio.ingargiola</p>
              </div>
            </a>
          </motion.div>
