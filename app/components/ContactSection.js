...
// IDs de EmailJS (public_key se puede pasar directo en send, así que los
// NEXT_PUBLIC_* son seguros para ir en el bundle del cliente).
...
export default function ContactSection() {
  ...
  // Mensaje de error real (para que el dueño del sitio sepa qué falló).
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/lucioingargiola"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 rounded-xl border border-[var(--line)] bg-[var(--bg-card)] transition-all duration-300 hover:-translate-y-0.5 hover:border-accent-50"
            >
