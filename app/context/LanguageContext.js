...
const translations = {
  es: {
    ...
    marketing: {
      ...
      services: [
        { icon: 'rocket', title: 'Landing Pages', text: 'Páginas de aterrizaje optimizadas para transformar visitas en clientes.' },
        { icon: 'trending', title: 'SEO & Rendimiento', text: 'Posicionamiento web y velocidad de carga para destacar en los buscadores.' },
        { icon: 'file', title: 'Contenido & Copywriting', text: 'Mensajes claros y textos persuasivos que comunican tu marca.' },
        { icon: 'share', title: 'Redes Sociales', text: 'Estrategia y piezas visuales para hacer crecer tu presencia online.' },
        { icon: 'mail', title: 'Email & Automatización', text: 'Campañas y flujos automáticos que fidelizan y venden.' },
        { icon: 'chart', title: 'Analítica & Reportes', text: 'Métricas claras y reportes accionables para medir resultados reales.' },
      ],
    ...
    recruiter: {
      ...
      profile: {
        ...
        items: [
          ...
          { label: 'Formación', value: 'Técnico en Desarrollo de Aplicaciones Informáticas' },
          { label: 'Stack principal', value: 'React · Next.js · JavaScript' },
          { label: 'También', value: 'Angular · Node.js · Marketing Digital' },
        ],
      },
      groups: [
        { title: 'Lenguajes & Web', skills: ['HTML5', 'CSS3', 'JavaScript (ES6+)', 'TypeScript'] },
        { title: 'Frameworks & Librerías', skills: ['React', 'Next.js', 'Angular', 'Node.js', 'Tailwind CSS', 'Framer Motion'] },
        { title: 'Datos & Backend', skills: ['MongoDB', 'Mongoose', 'Express', 'Firebase', 'REST APIs', 'JWT'] },
        { title: 'Herramientas & Workflows', skills: ['Git & GitHub', 'Vite', 'Postman', 'Figma', 'Canva', 'Webpack'] },
        { title: 'Editor & Audiovisual', skills: ['CapCut', 'Premiere Pro', 'Canva'] },
        { title: 'Inteligencia Artificial', skills: ['ChatGPT', 'Claude', 'GitHub Copilot', 'Cursor', 'Prompt Engineering', 'OpenAI API'] },
        { title: 'Habilidades Profesionales', skills: ['Responsive Design', 'UI/UX', 'SEO', 'Performance', 'Accesibilidad', 'Trabajo en equipo'] },
      ],
    },
    contact: {
      badge: 'Contacto',
      ...
      titleAccent: 'juntos',
      description:
        '¿Tenés un proyecto en mente? No dudes en consultarme.',
      email: 'Email',
      name: 'Nombre',
      namePlaceholder: 'Tu nombre',
      message: 'Mensaje',
    ...
    footer: {
      ...
      tagline: 'Experiencias web rápidas, accesibles y con una estética cuidada.',
    },
  },
  ...
  en: {
    ...
    marketing: {
      ...
      services: [
        { icon: 'rocket', title: 'Landing Pages', text: 'Conversion-optimized landing pages that turn visitors into customers.' },
        { icon: 'trending', title: 'SEO & Performance', text: 'Web positioning and load speed to stand out in search engines.' },
        { icon: 'file', title: 'Content & Copywriting', text: 'Clear messages and persuasive copy that communicates your brand.' },
        { icon: 'share', title: 'Social Media', text: 'Strategy and visual assets to grow your online presence.' },
        { icon: 'mail', title: 'Email & Automation', text: 'Campaigns and automated flows that retain and sell.' },
        { icon: 'chart', title: 'Analytics & Reports', text: 'Clear metrics and actionable reports to measure real results.' },
      ],
    ...
    recruiter: {
      ...
      profile: {
        ...
        items: [
          ...
          { label: 'Education', value: 'IT Application Development Technician' },
          { label: 'Main stack', value: 'React · Next.js · JavaScript' },
          { label: 'Also', value: 'Angular · Node.js · Digital Marketing' },
        ],
      },
      groups: [
        { title: 'Languages & Web', skills: ['HTML5', 'CSS3', 'JavaScript (ES6+)', 'TypeScript'] },
        { title: 'Frameworks & Libraries', skills: ['React', 'Next.js', 'Angular', 'Node.js', 'Tailwind CSS', 'Framer Motion'] },
        { title: 'Data & Backend', skills: ['MongoDB', 'Mongoose', 'Express', 'Firebase', 'REST APIs', 'JWT'] },
        { title: 'Tools & Workflows', skills: ['Git & GitHub', 'Vite', 'Postman', 'Figma', 'Canva', 'Webpack'] },
        { title: 'Editing & Audiovisual', skills: ['CapCut', 'Premiere Pro', 'Canva'] },
        { title: 'Artificial Intelligence', skills: ['ChatGPT', 'Claude', 'GitHub Copilot', 'Cursor', 'Prompt Engineering', 'OpenAI API'] },
        { title: 'Professional Skills', skills: ['Responsive Design', 'UI/UX', 'SEO', 'Performance', 'Accessibility', 'Teamwork'] },
      ],
    },
    contact: {
      badge: 'Contact',
      ...
      titleAccent: 'talk',
      description:
        "Have a project in mind? Don't hesitate to ask me.",
      email: 'Email',
      name: 'Name',
      namePlaceholder: 'Your name',
      message: 'Message',
